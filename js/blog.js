...
function commandProcessor(e){
  ...
  if(e.keyCode == 13){
    ...
    document.getElementById('injector').innerHTML= "";
    ...
    if(txtInput == "help"){
      document.getElementById('injector').innerHTML=help();
    }else if (txtInput=="all") {
      document.getElementById('injector').innerHTML=quick() + "\n\n\n" + skills() + "\n\n\n" + legal() + "\n\n\n" + contact() + "\n\n\n" + colorful();
    }else if (txtInput == "quick") {
      document.getElementById('injector').innerHTML=quick();
    }else if (txtInput == "contact") {
      document.getElementById('injector').innerHTML=contact();
    }else if (txtInput == "colorful") {
      document.getElementById('injector').innerHTML=colorful();
    }else if (txtInput=="skills") {
      document.getElementById('injector').innerHTML=skills();
    }else if (txtInput=="legal") {
      document.getElementById('injector').innerHTML=legal();
    }else if (txtInput == "scratchpad") {
      document.getElementById('injector').innerHTML=scratchpad();
    }else{
      document.getElementById('injector').innerHTML = help();
    }
